...
CREATE TABLE `master_employee` (
  `me_employeeid` varchar(8) NOT NULL,
  `me_firstname` varchar(60) NOT NULL,
  `me_middlename` varchar(60) NOT NULL,
  `me_lastname` varchar(60) NOT NULL,
  `me_department` varchar(60) NOT NULL,
  `me_position` varchar(60) NOT NULL,
  `me_type` varchar(60) NOT NULL,
  `me_image` blob NOT NULL,
  `me_status` varchar(20) NOT NULL,
  `me_createdby` varchar(300) NOT NULL,
  `me_createddate` varchar(20) NOT NULL,
  PRIMARY KEY (`me_employeeid`,`me_firstname`,`me_middlename`,`me_lastname`)
