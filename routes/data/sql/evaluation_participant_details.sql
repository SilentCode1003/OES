...
CREATE TABLE `participant_details` (
  `pd_detailid` int NOT NULL AUTO_INCREMENT,
  `pd_participantid` varchar(20) NOT NULL,
  `pd_year` varchar(20) NOT NULL,
  `pd_details` text NOT NULL,
  `pd_status` varchar(20) NOT NULL,
  `pd_createdby` varchar(300) NOT NULL,
  `pd_createddate` varchar(20) NOT NULL,
  PRIMARY KEY (`pd_detailid`,`pd_participantid`,`pd_year`)
