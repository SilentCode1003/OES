...
--
-- Table structure for table `master_subcriteria`
--

DROP TABLE IF EXISTS `master_subcriteria`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `master_subcriteria` (
  `ms_subcriteriacode` int NOT NULL AUTO_INCREMENT,
  `ms_criteria` varchar(250) NOT NULL,
  `ms_subcriteria` varchar(250) NOT NULL,
  `ms_createdby` varchar(120) NOT NULL,
  `ms_createddate` varchar(20) NOT NULL,
  PRIMARY KEY (`ms_subcriteriacode`,`ms_criteria`,`ms_subcriteria`)
