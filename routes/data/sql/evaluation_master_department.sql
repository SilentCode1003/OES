...
CREATE TABLE `master_department` (
  `md_departmentcode` int NOT NULL AUTO_INCREMENT,
  `md_department` varchar(120) NOT NULL,
  `md_createdby` varchar(120) NOT NULL,
  `md_creadteddate` varchar(20) NOT NULL,
  PRIMARY KEY (`md_departmentcode`,`md_department`)
