...
CREATE TABLE `master_position` (
  `mp_positioncode` int NOT NULL AUTO_INCREMENT,
  `mp_position` varchar(120) NOT NULL,
  `mp_department` varchar(120) NOT NULL,
  `mp_createdby` varchar(120) NOT NULL,
  `mp_createddate` varchar(20) NOT NULL,
  PRIMARY KEY (`mp_positioncode`,`mp_department`,`mp_position`)
